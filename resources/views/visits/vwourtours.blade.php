<x-cmplytnm>
    <div class="container-fluid custombody1 mt-5 pt-5 vh-100">
        <h2 class="text-center txtwht fs-1 mb-5 mt-5">Tutti i Tours</h2>
        <div class="row">
            <div class="col-12 d-flex justify-content-around wrapped">
                @foreach ($visits as $visit)
                    <div class="card mb-5" style="width: 18rem;">                    
                        @if($visit->is_default_image)  
                        <img class="imgcardvisit card-img-top" src="{{ asset($visit->img) }}" alt="{{ $visit->visitname }}" style="max-height: 200px; object-fit: cover;">
                        @else
                        ...
                        <div class="card-body h-25">
                            ...
                            <div class="">
                                @forelse($visit->categories as $category )
